...
{
    public class GetIncomingConsumersForExpertDashboardService : IGetIncomingConsumersForExpertDashboardService
    {
        private readonly ApplicationContext _context;

        public GetIncomingConsumersForExpertDashboardService(ApplicationContext context)
        {
            _context = context;
        }
